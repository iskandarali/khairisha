                        ...
                        <div class="card-body">
                            <form action="" method="post">
                                <div class="form-group">
                                    <label for="department_name">Nama Jabatan : </label>
                                    <input type="text" class="form-control" id="department_name" name="department_name" placeholder="Nama Jabatan" value="<?= set_value('department_name') ?>">
