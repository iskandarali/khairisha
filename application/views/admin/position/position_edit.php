                        ...
                        <div class="card-body">
                            <form action="" method="post">
                                <div class="form-group">
                                    <label for="position_name"><?= $position->position_name ?> :</label>
                                    <input type="text" class="form-control" id="position_name" name="position_name" placeholder="Nama <?= $position->position_name  ?>" value="<?= $position->position_name  ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="position_status" name="position_status">
                                        <option <?php if ($position->position_status == 1) echo 'selected' ?> value="1">Aktif</option>
                                        <option <?php if ($position->position_status == 2) echo 'selected' ?> value="2">Tidak Aktif</option>
                                    </select>
